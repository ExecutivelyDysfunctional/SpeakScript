...
android {
  ...
  defaultConfig {
    applicationId = "com.aistudio.transcribeai.xyzq"
    minSdk = 24
    targetSdk = 36
    versionCode = 1
    versionName = "1.0"
  ...
  signingConfigs {
    ...
    if (!debugKeystoreFile.exists() && debugBase64File.exists()) {
      try {
        ...
        // Ignore decode errors and fallback to default debug config
      }
    }
...
dependencies {
  ...
  // Firebase Authentication, Firestore, and Storage for cloud sync
